...
import com.zdh.alphathink.imh.Control.Box.IMHMsg;
import com.zdh.alphathink.imh.Control.Box.IMHMsgTextCoder;
...
public class  Medical_control extends Fragment {
    ...
    private Medical_control.AddAdapter addAdapter;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    Toast.makeText(getActivity(), "没有可用服务器", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_medical_control, container, false);
        bu1 = (Button) view.findViewById(R.id.mb1);
        bu2 = (Button) view.findViewById(R.id.b2);
        bu3 = (Button) view.findViewById(R.id.b3);
        bu4 = (Button) view.findViewById(R.id.b4);
        bu5 = (Button) view.findViewById(R.id.b5);
        bu6 = (Button) view.findViewById(R.id.b6);
        bu7 = (Button) view.findViewById(R.id.b7);
        bu8 = (Button) view.findViewById(R.id.b8);
        bu9 = (Button) view.findViewById(R.id.b9);
        tx_used = (TextView) view.findViewById(R.id.used);
        ...
        addAdapter = new Medical_control.AddAdapter(getActivity());
        ...
        bu1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                map.put("color","red");
                map.put("time","12:00");
                dbManager.insertInfo(map);

                String ii = String.valueOf(dbManager.getCount());
        ...
        Button imageButton = (Button) view.findViewById(R.id.ibtnAddNumber);
        imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MyDialog.Builder builder = new MyDialog.Builder(getActivity());
                LayoutInflater inflater = getActivity().getLayoutInflater();
                View layout = inflater.inflate(R.layout.my_dialog, (ViewGroup) view.findViewById(dialog));
                                ...
                                try {
                                    if (aCache.getAsJSONObject("date") != null) {
                                        if (js != null && c_id.getText().toString().equals(js.get("id"))) {
                                            Toast.makeText(getActivity(), "药箱编号已设置请检查！", Toast.LENGTH_SHORT).show();
                                        } else {
                                            try {
...
//        imageButton = (ImageButton) view.findViewById(R.id.goIndex);
//        imageButton.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
...
//        });
    ...
    public void initServer() {
        if (!CheckNetworkState.isWifi(getActivity())) {
            ...
            //如果连接后判断是否正确
        } else if (CheckNetworkState.isWifi(getActivity())) {
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    new Thread(new Medical_control.ReadThread(socket)).start();
                    socketStatus = true;
...
//内部类 listview适配相关
    class AddAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            Medical_control.AddAdapter.ViewHolder holder = new Medical_control.AddAdapter.ViewHolder();
            ACache aCache = ACache.get(getActivity());
            JSONObject jsonObject = aCache.getAsJSONObject("date");
            JSONArray jsonArray = null;
            ...
            if (convertView == null) {
                ...
                holder = (Medical_control.AddAdapter.ViewHolder) convertView.getTag();
            }
            if (json != null) {
                try {
